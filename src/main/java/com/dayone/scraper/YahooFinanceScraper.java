...
public class YahooFinanceScraper implements Scraper{
    ...
    private static final long START_TIME = 86400; // 하루의 시간(초) 60초 * 60분 * 24시
    ...
    public ScrapedResult scrap(Company company) {
        ...
        try {
            long now = System.currentTimeMillis() / 1000; // Millis을 초단위로 변환
            ...
            for (Element e : tbody.children()) {
                ...
                if (month < 0) {
                    throw new RuntimeException(
                            "Unecpected Month enum value -> " + splits[0]);
                }
